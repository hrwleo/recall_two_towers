...
from layers.model_layers import ResNetLayer
...
def two_towers(temperature, city_dict, shangquan_dict, comm_dict, tower_num_layer, tower_num_layer_units):
    ...
    user_feature = concatenate([user_city_emb, user_shangquan_emb, user_comm_emb,
                                user_shangquan_seq_emb, user_comm_seq_emb], axis=-1, name='user_feature')

    # 计算user tower的输出
    user_tower_out = ResNetLayer(hidden_units=tower_num_layer_units)(user_feature)
    ...
    item_feature = concatenate([item_city_emb, item_shangquan_emb, item_comm_emb, item_price_emb,
                                item_area_emb, item_floor_emb, item_total_floor_emb, item_room_emb,
                                item_hall_emb, item_bathroom_emb, item_prop_age, item_age_power2], axis=-1,
                               name='item_feature')

    # 计算item tower的输出
    item_tower_out = ResNetLayer(hidden_units=tower_num_layer_units)(item_feature)
